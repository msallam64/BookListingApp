...
public class MainActivity extends AppCompatActivity {
    ...
    private BookAdpter mBookAdapter;
    public static final String LOG_TAG = MainActivity.class.getName();
    ArrayList<Book> booksList;
    @Override
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        super.onRestoreInstanceState(savedInstanceState);
        booksList= (ArrayList<Book>) savedInstanceState.get("keyBookList");
        mBookAdapter = new BookAdpter(this, booksList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null ||
                !savedInstanceState.containsKey("keyBookLost")) {
            booksList = new ArrayList<>();
        } else {
            booksList = savedInstanceState.getParcelableArrayList
                    ("keyBookList");
        }


        final EditText inputString = (EditText)
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isOnline(getApplicationContext())) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.no_connect, Toast.LENGTH_LONG).show();
                }
            }
        });
        ListView bookListView = (ListView) findViewById(R.id.list);
    ...
    private class BookAsyncTask extends AsyncTask<String, Void, ArrayList<Book>> {
        ...
        private ArrayList<Book> extractFeatureFromJson(String bookJSON) {
            ...
            try {
                ...
                JSONArray itemArray = baseJsonResponse.optJSONArray("items");
                if (itemArray!=null) {
                    for (int i = 0; i < itemArray.length(); i++) {
                        ...
                        if (volumnInfo.has("authors")) {
                            JSONArray authorArray = volumnInfo.optJSONArray("authors");
